...
public class LoginLastFMFragment extends DialogFragment {
   ...
   // Define the listener of the interface type
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        context = getActivity();
        client = new LastFMClient(context);
   ...
   public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        btLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                client.login(etUsername.getText().toString(), etPassword.getText().toString(), new JsonHttpResponseHandler() {
                    @Override
                    ...
                    public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONArray errorResponse) {
                        Log.d("LoginLastFM", errorResponse.toString() );
                    }
    ...
    @Override
      public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
           ...
           // Get field from view
            ...
            etPassword = (EditText) view.findViewById(R.id.etUsername);
